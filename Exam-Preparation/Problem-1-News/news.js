    ...
    var news = [
        {
            ...
            Date: "13.06 | 21:32",
            theArticle: "Столичната община дава над 7 милиона лева за обновяването"
        },
        {
            image: "4. vegetables.jpg",
            title: "Доматите и краставиците са с 22% по-евтини",
            Date: "12.06 | 21:22",
            theArticle: "Според данните на НСИ цените на стоките и услугите у нас намаляват"
        },
        {
            image: "5. cars.jpg",
            title: "Полицаите на шофьорски изпит, ако управляват служебни коли",
            Date: "13.06 | 21:12",
            theArticle: "Kоито покажат слаб резултат, няма да могат да карат по време на работа"
        }
    ];
